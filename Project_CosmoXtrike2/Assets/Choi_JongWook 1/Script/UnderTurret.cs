...
public class UnderTurret : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        partToRotate.transform.localRotation = Quaternion.Euler(0f, rotation.y, 180f);
        //Vector3 targetpositionY = new Vector3(target.transform.position.x, target.transform.position.y, target.position.z);
        ...
        //partToYRotate.rotation = Quaternion.Euler(0f, 0f, rotationY.z);
